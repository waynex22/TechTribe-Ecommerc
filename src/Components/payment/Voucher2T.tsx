...
const Voucher2T: React.FC<Props> = ({ subOrder, refecth }) => {
    ...
    const listVoucherIsValid = listVoucherShow?.filter(isVoucherValid);
	...
	C375.874,334.702,378.973,337.798,378.973,341.62z"></path></svg>                                            <p className="font-normal">TechTribe</p>
                                            ...
                                            <div className="px-4">
                                                {subOrder?.subOrder?.voucher2t?._id === item._id ? (
                                                    ...
                                                    <>
                                                        {valid ? (
                                                            <div onClick={() => handleChooseVoucher(item)} className={`text-sm p-2 hover:opacity-80 rounded-lg ${valid ? 'text-blue-400 bg-blue-400/20 cursor-pointer' : 'text-gray-400 bg-gray-200'}`}>
                                                                Sử dụng
                                                            </div>
                                                        ) : (
