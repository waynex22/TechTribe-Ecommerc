      ...
      <Link to={`/product/${product?._id}`} className="col-span-1 rounded-lg border-solid border-[1px] border-gray-100 p-2">
        <div className="w-full h-[231px] relative">
          ...
          <div className="w-full mt-2">
            {product?.percent > 0 && (
              <>
                <div className="flex my-1 items-center justify-between bg-primary/10 w-fit rounded-lg backdrop-blur-0 text-primary py-[1px] px-[2px] gap-1">
                  <svg
                  ...
                  <span className="text-[10px] font-bold">Giá sốc</span>
                </div>
              </>
            )}
            {isNew && (
              <>
                <div className="flex items-center justify-between bg-red-500/10 w-fit rounded-lg backdrop-blur-0 text-red-500 py-[1px] px-[2px] gap-1">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 16 16"
                    fill="currentColor"
