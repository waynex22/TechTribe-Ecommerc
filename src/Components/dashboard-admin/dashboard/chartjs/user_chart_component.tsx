...
const UserLineChart: React.FC = () => {
  ...
  const data: ChartData = {
    ...
    datasets: [
      {
        label: 'Monthly User',
        data: [userJanuary,userFebruary,userMarch,userApril,userMay, userJune, userJuly,userAugust,userSeptember,userOctober,userNovember,userDecember],
      ...
      y: {
        ...
        ticks: {
          ...
          callback: function (value: number | string) {
            return typeof value === 'number' ? value.toString() + ' User' : value;
          },
        },
      },
    },
