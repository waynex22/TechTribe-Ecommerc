            ...
            <div className="bg-white p-4 rounded-lg">
                ...
                <div className='mt-6 border-t border-dashed'>
                    ...
                    {item?.discount2t > 0 && (
                     ...
                     {item?.coinRefunt > 0 && (
                        <div className="flex items-end justify-end gap-2 border-b border-gray-200 border-dashed">
                        <p className="w-[80%] border-r border-gray-200 border-dashed py-2 px-1 text-[14px] text-gray-400 text-end font-normal">Voucher từ Techtribe ( hoàn xu )</p>
                        <p className="w-[20%] py-2 px-1 text-[14px] text-gray-800 text-end font-normal">+{formatNumberVnd(item?.coinRefunt)} xu</p>
                    </div>
                    )}
                     {item?.coin > 0 && (
                        <div className="flex items-end justify-end gap-2 border-b border-gray-200 border-dashed">
                        <p className="w-[80%] border-r border-gray-200 border-dashed py-2 px-1 text-[14px] text-gray-400 text-end font-normal">Xu sử dụng</p>
                        <p className="w-[20%] py-2 px-1 text-[14px] text-gray-800 text-end font-normal">-{formatNumberVnd(item?.coin)} xu</p>
                    </div>
                    )}
                    <div className="flex items-end justify-end gap-2 border-b border-gray-200 border-dashed">
                ...
                <div className="flex items-center justify-between mt-4">
                    <div>
                        {item?.coinRefunt > 0 && (
                            <p className="text-xs text-gray-400 font-normal">Bạn sẽ được cộng {formatNumberVnd(item?.coinRefunt)} xu khi đơn hàng hoàn thành</p>
                        )}
                    </div>
